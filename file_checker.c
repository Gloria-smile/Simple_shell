#include "shell.h"
/**
 * file_check - checks to see if the command file exists in /bin/
 * @final_string: collects and verifies input line from user
 * Return: NULL if not found, else, returns the full path to the command
 */
