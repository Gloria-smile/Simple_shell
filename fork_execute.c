#include "shell.h"
/**
 * fork_execute_function - it executes the program in a child process
 * @array_string: displays the line input gotten from user in an array
 * @env:this represents the  parent array environmental variable
 * Return: void
 */
